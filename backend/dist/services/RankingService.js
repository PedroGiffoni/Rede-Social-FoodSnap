...
class RankingService {
    constructor() {
        this.rankingRepository = new RankingRepository_1.RankingRepository();
    }
    /*
    ...
    */
    buildRestaurantRanking(restaurants) {
        ...
        */
        const onlyWithReviews = ranking.filter((restaurant) => restaurant.reviewsCount > 0);
        /*
          Ordenação:
          1. Maior média
    ...
    */
    async getTopRestaurants() {
        const restaurants = await this.rankingRepository.getRestaurantsWithReviews();
    ...
    */
    async getTopRestaurantsByInfluencers() {
        const restaurants = await this.rankingRepository.getRestaurantsWithInfluencerReviews();
        return this.buildRestaurantRanking(restaurants);
    }
    /*
    ...
    */
    async getTopRestaurantsByCommunity() {
        const restaurants = await this.rankingRepository.getRestaurantsWithCommunityReviews();
        return this.buildRestaurantRanking(restaurants);
    }
}
