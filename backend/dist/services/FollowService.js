...
class FollowService {
    constructor() {
        this.followRepository = new FollowRepository_1.FollowRepository();
    ...
    async toggleFollow(followerId, followingId) {
        ...
        */
        if (existingFollow) {
            ...
            const followersCount = await this.followRepository.countFollowers(followingId);
            const followingCount = await this.followRepository.countFollowing(followerId);
            return {
                following: false,
